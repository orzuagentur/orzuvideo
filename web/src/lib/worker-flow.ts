...
export const FLOW_NODES: FlowNodeDef[] = [
  ...
  },
  {
    ...
    how: "Uploads the finished MP4 to the short-previews bucket and sets preview_url so Content cards can play drafts without YouTube.",
    connects: ["Used by ready drafts", "Publish-later can re-download this file"],
    needs: ["Service role", "Public bucket short-previews"],
    tips: ["If upload fails, local video_path still exists on the worker disk"],
  },
  {
    id: "draft_ready",
    label: "Ready (draft)",
